...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: wedding.meta.siteUrl },
      ...
      { property: "og:image:width", content: wedding.meta.ogImageWidth },
      { property: "og:image:height", content: wedding.meta.ogImageHeight },
